...
// Widget represents the widget type to be used in the user created screenboard.
type Widget struct {
...
// ScreenShareResponse represents the response object fot the ShareScreenboard service.
